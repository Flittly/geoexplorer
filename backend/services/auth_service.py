...
def verify_password(plain_password: str, hashed_password: str) -> bool:
    """Verify a password against its hash with 72-byte limit handling."""
    # bcrypt has a maximum password length of 72 bytes
...
async def store_refresh_token(
    db: Client, user_id: str, token: str, expires_delta: Optional[timedelta] = None
) -> None:
    """
...
async def get_user_by_email_or_phone(
    db: Client, email: Optional[str] = None, phone: Optional[str] = None
) -> Optional[dict]:
