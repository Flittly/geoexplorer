...
const Mistakes: React.FC = () => {
  ...
  const { data: mistakes, loading, error } = useMistakes({ category });
        ...
        <article className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-100 dark:border-slate-700 overflow-hidden group">
          <div className="p-4 flex flex-col gap-3">
            ...
            <div className="flex items-center gap-3 pt-2 mt-1 border-t border-slate-100 dark:border-slate-700">
              <button 
                onClick={() => navigate('/mistake/1')}
                className="flex-1 py-2 px-4 bg-primary hover:bg-blue-600 active:bg-blue-700 text-white rounded-lg text-sm font-semibold transition-colors flex items-center justify-center gap-2"
              >
              ...
              <button 
                onClick={() => navigate('/mistake/1')}
                className="flex-1 py-2 px-4 bg-slate-50 dark:bg-slate-700 hover:bg-slate-100 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-200 rounded-lg text-sm font-medium transition-colors border border-slate-200 dark:border-slate-600 flex items-center justify-center gap-2"
              >
